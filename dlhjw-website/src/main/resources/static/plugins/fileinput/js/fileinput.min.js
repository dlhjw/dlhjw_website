...
!function (e) {
    ...
    t = {
        ...
        cspBuffer: {
            CSP_ATTRIB: "data-csp-01928735", domElementsStyles: {}, stash: function (i) {
                ...
                n.find("[style]").each(function (i, r) {
                    var n = e(r), o = n[0].style, l = t.uniqId(), s = {};
        ...
        constructor: i, _cleanup: function () {
            ...
            if (a.enableResumableUpload) {
                ...
                i = a.resumableManager = {
                    init: function (e, t, n) {
                        ...
                        var n, l, s = i.id, d = i.$thumb, c = i.$progress, u = d && d.length,
                        ...
                        var d, c = i.chunkSize, u = i.id, p = i.file, f = i.$thumb, g = t.logMessages, m = i.$btnDelete,
                            h = function (e, t) {
                                t && (e = e.setTokens(t)), e = g.resumableRequestError.setTokens({msg: e}), a._log(e), s.reject(e)
                            };
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, h, v, w, b, _, C, y, x, T, P, F, k, E, S, I, A, D, z, j, U, M,
            ...
            var t, i, a = this, r = a.$modal.data("previewId") || "", n = a.getFrames().toArray(), o = n.length,
                l = a.$modal.find(".btn-kv-prev"), s = a.$modal.find(".btn-kv-next");
            ...
            var r, n, o, l, s, d, c, u, p, f, g = this, m = i.attr("id"), h = g._getZoom(m), v = g.$modal,
                w = v.find(".btn-kv-fullscreen"), b = v.find(".btn-kv-borderless"), _ = v.find(".btn-kv-toggleheader");
            n = h.attr("data-template") || "generic", r = h.find(".kv-file-content"), o = r.length ? r.html() : "", p = i.data("caption") || "", f = i.data("size") || "", l = p + " " + f, v.find(".kv-zoom-title").attr("title", e("<div/>").html(l).text()).html(l), s = v.find(".kv-zoom-body"), v.removeClass("kv-single-content"), a ? (u = s.addClass("file-thumb-loading").clone().insertAfter(s), t.setHtml(s, o).hide(), u.fadeOut("fast", function () {
                ...
                var i = t.which || t.keyCode, a = e(this).find(".btn-kv-prev"), r = e(this).find(".btn-kv-next"),
            ...
            var a, r, n, o, l = this, s = l.$modal.find(".kv-zoom-actions .btn-kv-" + t), d = l.getFrames().toArray(),
                c = [], u = d.length;
            if (!s.attr("disabled")) {
            ...
            if (this.showPreview) {
                var o, l = this, s = t.getFileName(i), d = n.type, c = n.name, u = l._parseFileType(d, s),
                    p = l.$preview, f = i.size || 0, g = "image" === u ? a.target.result : r, m = l.fileManager,
                    h = m.getId(i), v = l._getThumbId(h);
                o = l._generatePreviewTemplate(u, g, s, d, v, h, !1, f), l._clearDefaultPreview(), l._addToPreview(p, o);
                var w = l._getFrame(v);
                l._validateImageOrientation(w.find("img"), i, v, h, c, d, f, g), l._setThumbAttr(v, c, f), l._initSortable()
            }
            ...
            var c, u, p = this, f = null, g = p.autoOrientImage;
            ...
            var l, s, d, c = this, u = c.$preview, p = c._getFrame(e), f = p.attr("data-fileindex"), g = p.find("img");
            i = i || "Untitled", g.one("load", function () {
                s = p.width(), d = u.width(), s > d && g.css("width", "100%"), l = {
                    ind: f,
                    id: e,
                    fileId: t
                }, c._checkDimensions(f, "Small", g, p, i, "Width", l), c._checkDimensions(f, "Small", g, p, i, "Height", l), c.resizeImage || (c._checkDimensions(f, "Large", g, p, i, "Width", l), c._checkDimensions(f, "Large", g, p, i, "Height", l)), c._raise("fileimageloaded", [e]), c.fileManager.addImage(t, {
                    ind: f,
                    img: g,
                    thumb: p,
                    pid: e,
            ...
            if (c.$caption.length) {
                if (c.$captionContainer.removeClass("icon-visible"), a) r = e("<div>" + c.msgValidationError + "</div>").text(), l = c.fileManager.count(), l ? (d = c.fileManager.getFirstFile(), s = 1 === l && d ? d.nameFmt : c._getMsgSelected(l)) : s = c._getMsgSelected(c.msgNo),
                    n = t.isEmpty(i) ? s : i, o = '<span class="' + c.msgValidationErrorClass + '">' + c.msgValidationErrorIcon + "</span>"; else {
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var y, x, T, P, F, k, E, S, I, A, D, z, j = i[w], U = r._getFileId(j), M = c + "-" + U, $ = p.image,
                    R = r._getFileName(j, ""), O = (j && j.size || 0) / 1e3, B = "", L = t.createObjectURL(j), N = 0,
                    Z = "", H = !1, W = 0, q = function () {
                        var e = !!C.loadedImages[U], t = d.setTokens({index: w + 1, files: u, percent: 50, name: R});
                        setTimeout(function () {
                ...
                if (j) {
                    ...
                    if (0 === R.length) return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(j), "[unknown]")), void v(T, j, M, w, S);
                    if (t.isEmpty(m) || (B = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = O.toFixed(2), r.isAjaxUpload && C.exists(S) || r._getFrame(M, !0).length) {
    ...
    var a = 'class="kv-preview-data file-preview-pdf" src="{renderer}?file={data}" {style}',
        r = "btn btn-sm btn-kv " + t.defaultButtonCss(), n = "btn " + t.defaultButtonCss(!0);
